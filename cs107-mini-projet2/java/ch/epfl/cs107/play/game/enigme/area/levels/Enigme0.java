...
import ch.epfl.cs107.play.game.enigme.actor.SageSignal;
...
private Actor sageNorth, sageEast, sageSouth, sageWest;
	...
	public boolean begin(Window window, FileSystem fileSystem) {
		...
		sageNorth = new SageSignal(this, Orientation.LEFT, new DiscreteCoordinates(6, 14), "I seek the star that guided the pirates...", Orientation.UP);
		sageEast = new SageSignal(this, Orientation.DOWN, new DiscreteCoordinates(4, 16), "I seek a glimpse of dawn...", Orientation.RIGHT);
		sageSouth = new SageSignal(this, Orientation.UP, new DiscreteCoordinates(6, 18), "Help me face the warmth of family...", Orientation.DOWN);
		sageWest = new SageSignal(this, Orientation.RIGHT, new DiscreteCoordinates(8, 16), "I seek the crimson eye before twilight...", Orientation.LEFT);
