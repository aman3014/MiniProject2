...
public class Sprite extends ImageGraphics {
     ...
     */
    public Sprite(String name, float width, float height, Positionable parent, RegionOfInterest roi, Vector anchor, float alpha, float depthCorrection) {
        super(ResourcePath.getSprite(name), width, height, roi, anchor, alpha, -parent.getPosition().y+depthCorrection);
        setParent(parent);
